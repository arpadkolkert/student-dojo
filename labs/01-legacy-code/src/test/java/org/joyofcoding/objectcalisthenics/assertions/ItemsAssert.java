...
public class ItemsAssert extends AbstractIterableAssert<ItemsAssert, Iterable<ItemInt>, ItemInt> {

    protected ItemsAssert(Iterable<ItemInt> actual) {
        super(actual, ItemsAssert.class);
    }

    public static ItemsAssert assertThat(Iterable<ItemInt> actual) {
